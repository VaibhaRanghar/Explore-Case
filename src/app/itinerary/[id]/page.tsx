...
import { getPackageByURL, getPriceRange } from "@/lib/package";
...
const ToursPage = () => {
  ...
  if (!id || !url) {
    ...
    // currentTour = getPackageById(id.toString());
    currentTour = getPackageByURL(url.toString());
  }
  ...
  return (
    <>
      <Head>
        <meta name="title" content={currentTour.title}></meta>
      </Head>
                ...
                <div className="p-6">
                  <div className="bg-amber-50 border-l-4 border-amber-500 p-4 mb-4 rounded-r-lg">
                    <div className="flex items-start">
                      ...
                      <p className="text-amber-700 text-sm">
                        By booking this tour, you agree to all terms listed
                  ...
                  <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    <p className="text-blue-700 text-sm">
                      <span className="font-medium">Questions?</span> Contact
                      our support team for clarification on any terms.
                    </p>
                  </div>
                </div>
              </div>
